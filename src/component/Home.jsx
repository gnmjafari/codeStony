      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography variant="h5">
              خیلی از مواقع برای همه ما پیش آماده که جزوه ای برای برنامه نویسی
              بنویسیم و بعد از مدتی اینقدر تعداد برگه ها و جزوه ها زیاد میشه که
              دسترسی راحتی بهشون نداریم و حتی یادمون میره هر جزوه ای برای چه کدی
              نوشته شده، در Code Stony شما میتونید به راحتی برای هر جزوه موضوعی
              بنویسید و کد مربوط به اون جزوه را وارد کنید و متنی که به عنوان
              جزوه نیاز دارید بنویسید و با سرچ کردن در هر زمانی که خواستید به
              اون جزوه .و کدش دسترسی داشته باشید
            </Typography>
          </Box>
          <CardMedia
        ...
        <Timeline position="alternate" dir="ltr">
          ...
          <TimelineItem sx={{ minHeight: "150px" }}>
            <TimelineSeparator>
              <TimelineDot variant="outlined">
                <AccountCircleIcon sx={{ color: "#fff", fontSize: "60px" }} />
              </TimelineDot>
              <TimelineConnector sx={{ bgcolor: "#F8CE46" }} />
            </TimelineSeparator>
